...
def initialize_plot(PLOT2d, PLOT3d):
    if PLOT2d:
        ...
        ax.set_xlim(-8, 12)
        ax.set_ylim(-8, 12)
        text1, text2, text3, line1, line2 = ax.text(0,0,''), ax.text(0,0,''), ax.text(0,0,''), ax.text(0,0,''), ax.text(0,0,'')
        ...
        ax.set_ylim(-8, 12)
        ax.set_zlim(-8, 12)
        text1, text2, text3, lines = ax.text(0,0,''), ax.text(0,0,''), ax.text(0,0,''), [ax.text(0,0,'') for i in range(4)]
...
def update_plot(objects, fig, ax, env, PLOT2d, PLOT3d):
    if PLOT2d:
        ...
        text1=ax.scatter(0, 0, label='Angle: '+ str(env.angle_to_target()), c='r')
        text2=ax.scatter(0, 0, label='Distance: '+ str(env.dist_to_target()), c='r')
        text3=ax.scatter(0, 0, label='Orientation: '+ str(env.robot_orientation), c='r')
        plt.legend()
        plt.pause(0.00001)
    ...
    if PLOT3d:
        ...
        text1=ax.scatter(0, 0, 0, label='Angle: '+ str(env.angle_to_target()), c='r')
        text2=ax.scatter(0, 0, 0, label='Distance: '+ str(env.dist_to_target()), c='r')
        text3=ax.scatter(0, 0, 0, label='Orientation: '+ str(env.robot_orientation), c='r')
        plt.legend()
        plt.pause(0.00001)
        fig.canvas.draw_idle()
        fig.canvas.flush_events()
